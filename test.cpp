...
int giveColumn(string (&xor_res_arr)[6])
{
    ...
    // int co = 0;
    int col;
    if (xor_res_arr[1] == "0" && xor_res_arr[2] == "0" && xor_res_arr[3] == "0" &&
        xor_res_arr[4] == "0")
    {
        col = 0;
        return col;
    ...
    if (xor_res_arr[1] == "0" && xor_res_arr[2] == "0" && xor_res_arr[3] == "1" &&
        xor_res_arr[4] == "0")
    {
        col = 2;
        return col;
    ...
    if (xor_res_arr[1] == "0" && xor_res_arr[2] == "1" && xor_res_arr[3] == "0" &&
        xor_res_arr[4] == "")
    {
        col = 4;
        return col;
    ...
    if (xor_res_arr[1] == "0" && xor_res_arr[2] == "1" && xor_res_arr[3] == "1" &&
        xor_res_arr[4] == "0")
    {
        col = 6;
        return col;
    ...
    if (xor_res_arr[1] == "1" && xor_res_arr[2] == "0" && xor_res_arr[3] == "0" &&
        xor_res_arr[4] == "0")
    {
        col = 8;
        return col;
    ...
    if (xor_res_arr[1] == "1" && xor_res_arr[2] == "0" && xor_res_arr[3] == "1" &&
        xor_res_arr[4] == "0")
    {
        col = 10;
        return col;
    ...
    if (xor_res_arr[1] == "1" && xor_res_arr[2] == "1" && xor_res_arr[3] == "0" &&
        xor_res_arr[4] == "0")
    {
        col = 12;
        return col;
    ...
    if (xor_res_arr[1] == "1" && xor_res_arr[2] == "1" && xor_res_arr[3] == "1" &&
        xor_res_arr[4] == "0")
    {
        col = 14;
        return col;
...
void Decryption(string ivAfterBinary, string plaintextAftBin, string keyAfterBinary, string cipherText)
{
    ...
    string InverseInitialPermutationResult2 =
        InverseInitialPermutation(afterXORLRResult[15]);
    cout << endl;
...
string Encryption(string ivAfterBinary, string plaintextAftBin, string keyAfterBinary)
{
    ...
    string InverseInitialPermutationResult =
        InverseInitialPermutation(afterXORLRResult[15]);
    cout << endl;
